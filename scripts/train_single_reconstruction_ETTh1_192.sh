...
periodicity=24
dropout=0.1
experiment_id="ETTh1_${experiment_suffix}_${pred_len}"

log_file="logs/${model_name}_mae_reconstruction_ETTh1_${seq_len}_${pred_len}_${experiment_id}.log"
...
python -u run.py \
  ...
  --root_path ./dataset/ \
  --data_path ETTh1.csv \
  --model_id ETTh1_mae_${experiment_suffix}_${seq_len}_${pred_len}_${experiment_id} \
  --model $model_name \
  --data custom \
  --features M \
  --seq_len $seq_len \
