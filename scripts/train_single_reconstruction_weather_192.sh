...
periodicity=24
dropout=0.1
experiment_id="weather_${experiment_suffix}_${pred_len}"

log_file="logs/${model_name}_mae_reconstruction_weather_${seq_len}_${pred_len}_${experiment_id}.log"
...
python -u run.py \
  ...
  --model_id weather_mae_${experiment_suffix}_${seq_len}_${pred_len}_${experiment_id} \
  --model $model_name \
  --data custom \
  --features M \
  --seq_len $seq_len \
