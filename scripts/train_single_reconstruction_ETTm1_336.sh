...
periodicity=24
dropout=0.1
experiment_id="ETTm1_${experiment_suffix}_${pred_len}"

log_file="logs/${model_name}_mae_reconstruction_ETTm1_${seq_len}_${pred_len}_${experiment_id}.log"
...
python -u run.py \
  ...
  --root_path ./dataset/ \
  --data_path ETTm1.csv \
  --model_id ETTm1_mae_${experiment_suffix}_${seq_len}_${pred_len}_${experiment_id} \
  --model $model_name \
  --data custom \
  --features M \
  --seq_len $seq_len \
