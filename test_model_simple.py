...
def test_coupled_mamba_fusion():
    """测试coupled-mamba融合模块"""
    print("="*60)
    print("Time-MaC Coupled-Mamba Fusion 测试")
    print("="*60)
...
def test_time_me_model():
    """测试完整的 Time-MaC/Time-me 模型（简化版）"""
    print("\n" + "="*60)
    print("Time-MaC 完整模型测试（简化版）")
    print("="*60)
